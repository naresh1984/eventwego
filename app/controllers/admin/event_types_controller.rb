class Admin::EventTypesController < AdminController
 ...
 # GET /event_types
  ...
  def create
    ...
    respond_to do |format|
      if @event_type.save
        format.html { redirect_to admin_event_types_path, notice: 'Event type was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @event_type.update_attributes(params[:event_type])
        format.html { redirect_to admin_event_types_path, notice: 'Event type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_event_types_url ,notice: "Event type (#{name}) was successfully deleted." }
      format.json { head :no_content }
    end
  end
