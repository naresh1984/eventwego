...
:status
  has_attached_file :avatar, :styles => { :medium => "300x300>", :thumb => "267x175!>", :small => "146x97!>" }, :default_url => "default_upload_logo.gif",:path => ":rails_root/uploads/system/events/images/:id/:style/:filename",:url => ":base/uploads/system/events/images/:id/:style/:filename"  
