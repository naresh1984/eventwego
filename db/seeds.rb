...
event = Event.create(name:'naresh', start_at: Date.today, end_at: Date.today, city: results[0].city , event_type_id: @type.id, event_language_id: @lan.id, latitude: results[0].latitude, longitude: results[0].longitude, state: results[0].state, country: results[0].country, zipcode: results[0].postal_code,start_minute: 00 ,start_hour: 9 ,start_meridiem: 1,end_minute: 00 ,end_hour: 11,end_meridiem: 1, address: 'Hyderabad, Andhra Pradesh, India',content:'hii',venue:'hyd' )
